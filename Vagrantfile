...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    # PowerShell commands to mount the ISO and start SQL Server installation
    $isoPath = "D:"  # The drive letter typically assigned to the CD/DVD drive in VirtualBox

    if (Test-Path "$isoPath\\setup.exe") {
